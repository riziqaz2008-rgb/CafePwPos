    ...
    <div>
        <div>
            <div class="flex gap-x-5 mt-3">
                <div class="hidden w-13 h-13 rounded-2xl bg-primary border border-indigo-100/80 lg:flex items-center justify-center shrink-0 shadow-sm">
                    <i class="bx bx-hexagon text-2xl text-secondary"></i>
                </div>
                <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 mt-8">
            <div class="lg:col-span-full space-y-6">
                <div class="bg-white border-y border-gray-200/80 p-6 lg:p-7">
                    <div class="flex items-start justify-between mb-7">
                        ...
                        <div class="w-11 h-11 bg-primary rounded-[14px] flex items-center justify-center text-secondary shrink-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input
                                type="text"
                                value="KedaiKu Cafe"
                                class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white text-sm font-medium text-[#12131a] outline-none focus:border-primary focus:ring-2 focus:ring-blue-100 transition">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-[#12131a] mb-2">
                                Nomor Telepon
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea
                                rows="3"
                                class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white text-sm font-medium text-[#12131a] outline-none focus:border-primary focus:ring-2 focus:ring-blue-100 transition resize-none">Jl. Pandan Wangi, Samarinda</textarea>
                        </div>
                    </div>
                    <div class="flex justify-end mt-7 pt-6 border-t border-gray-100">
                        <button
                            class="flex items-center gap-2 bg-primary hover:bg-blue-700 text-secondary font-bold text-sm px-5 py-3 rounded-xl transition cursor-pointer">
                            <i class="bx bx-save text-lg"></i>
                            Simpan Informasi
                        </button>
                    </div>
                </div>
                <div class="bg-white border-b border-gray-200/80  p-6 lg:p-7">
                    <div class="flex items-start justify-between mb-7">
                        <div>
                            <h2 class="text-[20px] font-black text-[#12131a] tracking-tight">
                                Tampilan & Branding
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-5 p-4 rounded-xl border border-gray-100 bg-gray-50/50">
                                <div class="w-20 h-20 rounded-2xl bg-white border border-gray-200 p-2 flex items-center justify-center shrink-0 shadow-sm relative group">
                                    <div class="w-12 h-12 rounded-xl bg-primary flex items-center justify-center text-secondary font-black text-xl">
                                        <i class="bx bx-hexagon"></i>
                                    </div>
                                </div>
                                <div class="flex-1">
                                    <div class="flex flex-wrap items-center gap-3">
                                        <label class="px-4 py-2.5 rounded-xl bg-primary hover:bg-blue-700 text-secondary text-sm font-bold cursor-pointer transition flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap items-center gap-4">
                                <label class="cursor-pointer relative">
                                    ...
                                    <div class="w-10 h-10 rounded-xl bg-indigo-600 flex items-center justify-center text-secondary ring-2 ring-offset-2 ring-transparent peer-checked:ring-indigo-600 transition shadow-sm">
                                ...
                                <label class="cursor-pointer relative">
                                    ...
                                    <div class="w-10 h-10 rounded-xl bg-emerald-600 flex items-center justify-center text-secondary ring-2 ring-offset-2 ring-transparent peer-checked:ring-emerald-600 transition shadow-sm">
                                        <i class="bx bx-check text-lg opacity-0 peer-checked:opacity-100"></i>
                                    </div>
                                </label>
                                <label class="cursor-pointer relative">
                                    <input type="radio" name="theme_color" value="#7C3AED" class="sr-only peer">
                                    <div class="w-10 h-10 rounded-xl bg-violet-600 flex items-center justify-center text-secondary ring-2 ring-offset-2 ring-transparent peer-checked:ring-violet-600 transition shadow-sm">
                                        <i class="bx bx-check text-lg opacity-0 peer-checked:opacity-100"></i>
                                    </div>
                                </label>
                                <label class="cursor-pointer relative">
                                    <input type="radio" name="theme_color" value="#E11D48" class="sr-only peer">
                                    <div class="w-10 h-10 rounded-xl bg-rose-600 flex items-center justify-center text-secondary ring-2 ring-offset-2 ring-transparent peer-checked:ring-rose-600 transition shadow-sm">
                                        <i class="bx bx-check text-lg opacity-0 peer-checked:opacity-100"></i>
                                    </div>
                                </label>
                                <label class="cursor-pointer relative">
                                    <input type="radio" name="theme_color" value="#D97706" class="sr-only peer">
                                    <div class="w-10 h-10 rounded-xl bg-amber-600 flex items-center justify-center text-secondary ring-2 ring-offset-2 ring-transparent peer-checked:ring-amber-600 transition shadow-sm">
                                        <i class="bx bx-check text-lg opacity-0 peer-checked:opacity-100"></i>
                                    </div>
                                </label>
